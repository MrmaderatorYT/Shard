...
public class Xml extends Highlighter {
    ...
    protected void applyHighlights(SpannableStringBuilder sb) {
        ...
        applyPattern(sb, code, "<\\?[^?]*\\?>", COLOR_PREPROCESSOR, false);
        applyPattern(sb, code, "<!?/?[a-zA-Z_:][a-zA-Z0-9_.:-]*", COLOR_TAG, false);
        applyPattern(sb, code, "/?>", COLOR_TAG, false);
        applyPattern(sb, code, "[a-zA-Z_:][a-zA-Z0-9_.:-]*(?==)", COLOR_ATTR, false);
